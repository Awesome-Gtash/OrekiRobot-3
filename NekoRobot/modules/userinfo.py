...
NEKO_IMG = "https://te.legra.ph/file/b46cef420c7d5c469ef82.jpg"
...
def info(update: Update, context: CallbackContext):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text="Support", url="https://t.me/Tigerr_Support"
            ),
        ],
    ]
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Source Code🌐", url="github.com/Awesome-Gtash/OrekiRobot"
                        )
                    ]
                ]
            ),
        ...
        update.effective_message.reply_text(
            (
                (
                    ...
                    + f"\n\n✦ [Support](https://t.me/{SUPPORT_}) | ✦ [Updates](https://t.me/Programmer_Updates)\n\n"
                )
                + "╘══「 by [White Tiger • Network](https://t.me/Tiger_Networkk) 」\n"
            ),
            parse_mode=ParseMode.MARKDOWN,
