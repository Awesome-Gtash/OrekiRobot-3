...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("More Help", url=f"t.me/OrekiXProRobot?start=start"),
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://te.legra.ph/file/b0fac93bd1a4f4c095dbe.jpg",
...
**My Master:** [Myaav Boi](t.me/Awesome_MB)
"""
