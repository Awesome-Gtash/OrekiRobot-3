...
OREKI_MOD.add_handler(RBAN_HANDLER)
OREKI_MOD.add_handler(RUNBAN_HANDLER)
OREKI_MOD.add_handler(RKICK_HANDLER)
OREKI_MOD.add_handler(RMUTE_HANDLER)
OREKI_MOD.add_handler(RUNMUTE_HANDLER)
