...
from OrekiRobot import DRAGONS, LOGGER, OREKI_MOD, TIGERS, WOLVES
...
OREKI_MOD.add_handler(REPORT_BUTTON_USER_HANDLER)

OREKI_MOD.add_handler(SETTING_HANDLER)
OREKI_MOD.add_handler(REPORT_HANDLER, REPORT_GROUP)
OREKI_MOD.add_handler(ADMIN_REPORT_HANDLER, REPORT_GROUP)
