...
OREKI_MOD.add_handler(FILTER_HANDLER)
OREKI_MOD.add_handler(STOP_HANDLER)
OREKI_MOD.add_handler(LIST_HANDLER)
OREKI_MOD.add_handler(CUST_FILTER_HANDLER, HANDLER_GROUP)
OREKI_MOD.add_handler(RMALLFILTER_HANDLER)
OREKI_MOD.add_handler(RMALLFILTER_CALLBACK)
