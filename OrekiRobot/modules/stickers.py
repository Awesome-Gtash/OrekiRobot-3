...
OREKI_MOD.add_handler(STICKERS_HANDLER)
OREKI_MOD.add_handler(STICKERID_HANDLER)
OREKI_MOD.add_handler(GETSTICKER_HANDLER)
OREKI_MOD.add_handler(KANG_HANDLER)
OREKI_MOD.add_handler(DELKANG_HANDLER)
