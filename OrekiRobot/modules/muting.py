...
from OrekiRobot import LOGGER, OREKI_MOD, TIGERS
...
OREKI_MOD.add_handler(MUTE_HANDLER)
OREKI_MOD.add_handler(UNMUTE_HANDLER)
OREKI_MOD.add_handler(TEMPMUTE_HANDLER)
