...
from OrekiRobot import OREKI_MOD, updater
from OrekiRobot.modules.helper_funcs.chat_status import user_admin
from OrekiRobot.modules.sql import rss_sql as sql
...
OREKI_MOD.add_handler(SHOW_URL_HANDLER)
OREKI_MOD.add_handler(ADD_URL_HANDLER)
OREKI_MOD.add_handler(REMOVE_URL_HANDLER)
OREKI_MOD.add_handler(LIST_URLS_HANDLER)
