...
if is_module_loaded(FILENAME):
    ...
    from OrekiRobot import EVENT_LOGS, LOGGER, OREKI_MOD
    ...
    def __chat_settings__(chat_id, user_id):
        if log_channel := sql.get_chat_log_channel(chat_id):
            log_channel_info = OREKI_MOD.bot.get_chat(log_channel)
...
"""
    ...
    OREKI_MOD.add_handler(LOG_HANDLER)
    OREKI_MOD.add_handler(SET_LOG_HANDLER)
    OREKI_MOD.add_handler(UNSET_LOG_HANDLER)
