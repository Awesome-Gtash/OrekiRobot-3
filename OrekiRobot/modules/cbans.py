...
@orekicmd(command="cban", pass_args=True)
@connection_status
@bot_admin
@can_restrict
...
@orekicmd(command="tcban", pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@orekicmd(command="kick", pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@orekicmd(command="kickme", pass_args=True, filters=Filters.chat_type.groups)
@bot_admin
@can_restrict
...
@orekicmd(command="uncban", pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@orekicmd(command="selfunban", pass_args=True)
@connection_status
@bot_admin
@can_restrict
@gloggable
