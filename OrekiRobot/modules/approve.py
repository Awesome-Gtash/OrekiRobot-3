...
OREKI_MOD.add_handler(APPROVE)
OREKI_MOD.add_handler(DISAPPROVE)
OREKI_MOD.add_handler(APPROVED)
OREKI_MOD.add_handler(APPROVAL)
OREKI_MOD.add_handler(UNAPPROVEALL)
OREKI_MOD.add_handler(UNAPPROVEALL_BTN)
