...
def inlinequery(update: Update, _) -> None:
    ...
    if (f := query.split(" ", 1)[0]) in inline_funcs:
        ...
        inline_help_dicts = [
            ...
            {
                "title": "Account info on Prince Oreki",
                "description": "Look up a Telegram account in Miku database",
                "message_text": "Click the button below to look up a person in Prince Oreki database using their Telegram ID",
                "thumb_urL": "https://telegra.ph/file/0bf1b29555518a0d45948.jpg",
                "keyboard": ".info ",
            },
            {
                "title": "About",
                "description": "Know about Prince Oreki",
                "message_text": "Click the button below to get to know about Prince Oreki.",
                "thumb_urL": "https://telegra.ph/file/0bf1b29555518a0d45948.jpg",
                "keyboard": ".about ",
            },
            {
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Report Error", url="https://t.me/Tiger_SupportChat"
                ),
                InlineKeyboardButton(
                    text="Search again",
        ...
        kb = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="Report error",
                        url="https://t.me/Tiger_SupportChat",
                    ),
                    InlineKeyboardButton(
                        text="Search again",
                        switch_inline_query_current_chat=".anilist ",
