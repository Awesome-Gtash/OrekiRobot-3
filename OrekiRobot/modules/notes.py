...
from OrekiRobot import DRAGONS, JOIN_LOGGER, LOGGER, OREKI_MOD, SUPPORT_CHAT
...
OREKI_MOD.add_handler(GET_HANDLER)
OREKI_MOD.add_handler(SAVE_HANDLER)
OREKI_MOD.add_handler(LIST_HANDLER)
OREKI_MOD.add_handler(DELETE_HANDLER)
OREKI_MOD.add_handler(HASH_GET_HANDLER)
OREKI_MOD.add_handler(SLASH_GET_HANDLER)
OREKI_MOD.add_handler(CLEARALL)
OREKI_MOD.add_handler(CLEARALL_BTN)
