...
def neko(update, context):
    msg = update.effective_message
    target = "oreki"
    msg.reply_photo(oreki.img(target))
...
def sologif(update, context):
    ...
    msg = update.effective_message
    target = "solog"
    msg.reply_video(oreki.img(target))
...
OREKI_MOD.add_handler(ADD_NSFW_HANDLER)
OREKI_MOD.add_handler(REMOVE_NSFW_HANDLER)
OREKI_MOD.add_handler(LIST_NSFW_CHATS_HANDLER)
OREKI_MOD.add_handler(LEWDKEMO_HANDLER)
OREKI_MOD.add_handler(NEKO_HANDLER)
OREKI_MOD.add_handler(FEET_HANDLER)
OREKI_MOD.add_handler(YURI_HANDLER)
OREKI_MOD.add_handler(TRAP_HANDLER)
OREKI_MOD.add_handler(FUTANARI_HANDLER)
OREKI_MOD.add_handler(HOLOLEWD_HANDLER)
OREKI_MOD.add_handler(SOLOGIF_HANDLER)
OREKI_MOD.add_handler(CUMGIF_HANDLER)
OREKI_MOD.add_handler(EROKEMO_HANDLER)
OREKI_MOD.add_handler(LESBIAN_HANDLER)
OREKI_MOD.add_handler(WALLPAPER_HANDLER)
OREKI_MOD.add_handler(LEWDK_HANDLER)
OREKI_MOD.add_handler(NGIF_HANDLER)
OREKI_MOD.add_handler(TICKLE_HANDLER)
OREKI_MOD.add_handler(LEWD_HANDLER)
OREKI_MOD.add_handler(FEED_HANDLER)
OREKI_MOD.add_handler(EROYURI_HANDLER)
OREKI_MOD.add_handler(ERON_HANDLER)
OREKI_MOD.add_handler(CUM_HANDLER)
OREKI_MOD.add_handler(BJGIF_HANDLER)
OREKI_MOD.add_handler(BJ_HANDLER)
OREKI_MOD.add_handler(NEKONSFW_HANDLER)
OREKI_MOD.add_handler(SOLO_HANDLER)
OREKI_MOD.add_handler(KEMONOMIMI_HANDLER)
OREKI_MOD.add_handler(AVATARLEWD_HANDLER)
OREKI_MOD.add_handler(GASM_HANDLER)
OREKI_MOD.add_handler(POKE_HANDLER)
OREKI_MOD.add_handler(ANAL_HANDLER)
OREKI_MOD.add_handler(HENTAI_HANDLER)
OREKI_MOD.add_handler(AVATAR_HANDLER)
OREKI_MOD.add_handler(EROFEET_HANDLER)
OREKI_MOD.add_handler(HOLO_HANDLER)
OREKI_MOD.add_handler(TITS_HANDLER)
OREKI_MOD.add_handler(PUSSYGIF_HANDLER)
OREKI_MOD.add_handler(HOLOERO_HANDLER)
OREKI_MOD.add_handler(PUSSY_HANDLER)
OREKI_MOD.add_handler(HENTAIGIF_HANDLER)
OREKI_MOD.add_handler(CLASSIC_HANDLER)
OREKI_MOD.add_handler(KUNI_HANDLER)
OREKI_MOD.add_handler(LEWD_HANDLER)
OREKI_MOD.add_handler(KISS_HANDLER)
OREKI_MOD.add_handler(FEMDOM_HANDLER)
OREKI_MOD.add_handler(CUDDLE_HANDLER)
OREKI_MOD.add_handler(HUG_HANDLER)
OREKI_MOD.add_handler(EROK_HANDLER)
OREKI_MOD.add_handler(FOXGIRL_HANDLER)
OREKI_MOD.add_handler(TITSGIF_HANDLER)
OREKI_MOD.add_handler(ERO_HANDLER)
OREKI_MOD.add_handler(SMUG_HANDLER)
OREKI_MOD.add_handler(BAKA_HANDLER)
OREKI_MOD.add_handler(DVA_HANDLER)
