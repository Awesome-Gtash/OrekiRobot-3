...
@orekicmd(command="blacklist", pass_args=True, admin_ok=True)
@u_admin
@typing_action
...
@orekicmd(command="addblacklist", pass_args=True)
...
@orekicmd(command="unblacklist", pass_args=True)
@user_admin(AdminPerms.CAN_DELETE_MESSAGES)
@typing_action
...
@orekicmd(command="blacklistmode", pass_args=True)
@loggable
