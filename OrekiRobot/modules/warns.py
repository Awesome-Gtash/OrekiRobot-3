...
# OREKI_MOD handler stop - do not async
@user_admin
def add_warn_filter(update: Update, context: CallbackContext):
    ...
    for handler in OREKI_MOD.handlers.get(WARN_HANDLER_GROUP, []):
        if handler.filters == (keyword, chat.id):
            OREKI_MOD.remove_handler(handler, WARN_HANDLER_GROUP)
...
OREKI_MOD.add_handler(WARN_HANDLER)
OREKI_MOD.add_handler(CALLBACK_QUERY_HANDLER)
OREKI_MOD.add_handler(RESET_WARN_HANDLER)
OREKI_MOD.add_handler(REMOVE_WARN_HANDLER)
OREKI_MOD.add_handler(MYWARNS_HANDLER)
OREKI_MOD.add_handler(ADD_WARN_HANDLER)
OREKI_MOD.add_handler(RM_WARN_HANDLER)
OREKI_MOD.add_handler(LIST_WARN_HANDLER)
OREKI_MOD.add_handler(WARN_LIMIT_HANDLER)
OREKI_MOD.add_handler(WARN_STRENGTH_HANDLER)
OREKI_MOD.add_handler(WARN_FILTER_HANDLER, WARN_HANDLER_GROUP)
