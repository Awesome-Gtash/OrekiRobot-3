...
from OrekiRobot import LOGGER, OREKI_MOD
...
OREKI_MOD.add_handler(BLACKLIST_STICKER_HANDLER)
OREKI_MOD.add_handler(ADDBLACKLIST_STICKER_HANDLER)
OREKI_MOD.add_handler(UNBLACKLIST_STICKER_HANDLER)
OREKI_MOD.add_handler(BLACKLISTMODE_HANDLER)
OREKI_MOD.add_handler(BLACKLIST_STICKER_DEL_HANDLER)
