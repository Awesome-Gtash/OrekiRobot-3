...
OREKI_MOD.add_handler(BAN_HANDLER)
OREKI_MOD.add_handler(TEMPBAN_HANDLER)
OREKI_MOD.add_handler(KICK_HANDLER)
OREKI_MOD.add_handler(UNBAN_HANDLER)
OREKI_MOD.add_handler(ROAR_HANDLER)
OREKI_MOD.add_handler(KICKME_HANDLER)
OREKI_MOD.add_handler(UNBAN_BUTTON_HANDLER)
OREKI_MOD.add_handler(SNIPE_HANDLER)
OREKI_MOD.add_handler(BANME_HANDLER)
