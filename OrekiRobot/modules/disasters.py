...
OREKI_MOD.add_handler(SUDO_HANDLER)
OREKI_MOD.add_handler(SUPPORT_HANDLER)
OREKI_MOD.add_handler(TIGER_HANDLER)
OREKI_MOD.add_handler(WHITELIST_HANDLER)
OREKI_MOD.add_handler(UNSUDO_HANDLER)
OREKI_MOD.add_handler(UNSUPPORT_HANDLER)
OREKI_MOD.add_handler(UNTIGER_HANDLER)
OREKI_MOD.add_handler(UNWHITELIST_HANDLER)

OREKI_MOD.add_handler(WHITELISTLIST_HANDLER)
OREKI_MOD.add_handler(TIGERLIST_HANDLER)
OREKI_MOD.add_handler(SUPPORTLIST_HANDLER)
OREKI_MOD.add_handler(SUDOLIST_HANDLER)
OREKI_MOD.add_handler(DEVLIST_HANDLER)
